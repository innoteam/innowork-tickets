...
class InnoworkticketsPanelViews extends \Innomatic\Desktop\Panel\PanelViews
{
    ...
    public function beginHelper()
    {
        ...
        $this->innomaticContainer = InnomaticContainer::instance('\Innomatic\Core\InnomaticContainer');
    ...
    public function viewDefault($eventData)
    {
        ...
        if (isset($eventData['filter'])) {
            ...
            if (strlen($channel_filter_sk->mValue) and $channel_filter_sk->mValue != 0) {
        ...
        $tab_sess = new WuiSessionKey(
            'innoworkticketstab', array('value' => $eventData['done'])
        );
            ...
            <vertgroup>
              <children>
                ...
                <label><name>title</name>
                  <args>
                    <bold>true</bold>
                    <label>'.($this->localeCatalog->getStr((isset($eventData['done']) and $eventData['done'] == 'true') ? 'donetickets.label' : 'tickets.label')).'</label>
                  </args>
                </label>
                          ...
                          <children>
                            <link>
                              <args>
                                ...
                                .WuiXml::cdata(
                                    \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                        '', array(array('view', 'showticket', array('id' => $ticket['id'])))
                                    )
                                ).'</link>
                                </args>
                            </link>
                                    ...
                                    'view' => array(
                                        ...
                                        'done' => array(
                                            ...
                                            'action' => \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                                ...
                                                array(
                                                    array('view', 'default', ''),
                                                    array('action', 'editticket', array('id' => $ticket['id'], 'done' => $done_action))
                                                )
                                            )
                                        ),
                                        'trash' => array(
                                            ...
                                            'action' => \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                                ...
                                                array(
                                                    array('view', 'default', ''),
                                                    array('action', 'trashticket', array('id' => $ticket['id']))
                                                )
                                            )
                                        )
                                    )
    ...
    public function viewNewticket($eventData)
    {
        // Companies
                      ...
                      <args>
                            ...
                            .WuiXml::cdata(
                                \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                    '',
                                    array(
                                        array('view', 'showticket'),
                                        array('action', 'newticket')
                                    )
                                )
                            ).'</action>
                      </args>
    ...
    public function viewShowticket($eventData)
    {
        ...
        $ticket_data = $innowork_ticket->getItem($this->innomaticContainer->getCurrentUser()->getUserId());
        ...
        if ($ticket_data['projectid'] == '' or $ticket_data['projectid'] == 0) {
            $projects_search_conditions['done'] = $this->innomaticContainer->getDataAccess()->fmtfalse;
        }
        ...
        if ($ticket_data['done'] == $this->innomaticContainer->getCurrentDomain()->getDataAccess()->fmttrue) {
            $done_icon = 'misc3';
            $done_action = 'false';
            $done_label = 'setundone.button';
        } else {
            ...
            <horizgroup>
                      ...
                      <args>
                            ...
                            .WuiXml::cdata(
                                \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                    '',
                                    array(
                                        array('view', 'showticket', array('id' => $eventData['id'])),
                                        array('action', 'editticket', array('id' => $eventData['id']))
                                    )
                                )
                            ).'</action>
                      </args>
                            ...
                            <horizgroup>
                              ...
                              <children>
                                ...
                                <combobox><name>customerid</name>
                                  ...
                                  <events>
                                    <change>
                                        var v1 = document.getElementById(\'customerid\').value;
                                        xajax_OnChangeListProjects(v1);
                                    </change>
                                  </events>
                                </combobox>
                      ...
                      <children>
                        ...
                        <button>
                          <args>
                            ...
                            .WuiXml::cdata(
                                \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                    '', array(array('view', 'addmessage', array('ticketid' => $eventData['id'])))
                                )
                            ).'</action>
                          </args>
                        </button>
                          ...
                          <args>
                            ...
                            .WuiXml::cdata(
                                \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                    ...
                                    array(
                                        array('view', 'default', ''),
                                        array('action', 'editticket', array('id' => $eventData['id'], 'done' => $done_action))
                                    )
                                )
                            ).'</action>
              ...
              <innoworkitemacl><name>itemacl</name>
                <args>
                    ...
                    .WuiXml::cdata(
                        \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                            '', array(array('view', 'showticket', array('id' => $eventData['id'])))
                        )
                    ).'</defaultaction>
                </args>
              </innoworkitemacl>
    ...
    public function viewTicketmessages($eventData)
    {
        $innowork_ticket = new InnoworkTicket(
            $this->innomaticContainer->getDataAccess(),
            $this->innomaticContainer->getCurrentDomain()->getDataAccess(),
                            ...
                            \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                                ...
                                array(
                                    array(
                                        'view',
                                        'ticketmessages',
                                        array('ticketid' => $eventData['ticketid'])
                                    ),
                                    array(
                                        'action',
                                        'removemessage',
                  ...
                  <args>
                    ...
                    .WuiXml::cdata(
                        \Innomatic\Wui\Dispatch\WuiEventsCall::buildEventsCallString(
                            '',
                            array(
                                array('view', 'ticketmessages', array('ticketid' => $eventData['ticketid'])),
                                array('action', 'newmessage', array('ticketid' => $eventData['ticketid']))
                            )
                        )
                    ).'</action>
                  </args>
